...
//public void demo_templateOps(){
//    BoundValueOperations<String,String> listOps= redisTemplate.boundValueOps("silent");
//    print(1,listOps.get());
//    print(2,listOps.getAndSet("goodjob"));
//    print(3,listOps.get());
//    print(4,listOps.size());
//}
